...
Copy `cursor-rules.txt` to your project's `.cursorrules` file or add its contents to your existing rules.

## Available Tools

When the MCP server is connected, Cursor will have access to:
